...
loss_y  = []
loss_mssg = []
save_path = "_Competitive-AutoEncoder-V11-(Stack Training)/pthSaves/stack1/" # Save and load path
...
loadfile = model_type + "_ep" + str(ep)
load_path = path + "stack" + str(stack) + "/" # Save and load path
new_model_load, optim_load = load_model(loadfile, load_path)
...
#%%
# Deconvolution layer filter plotting
deconv_filter_plot(new_model_load)
